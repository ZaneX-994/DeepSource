...
if __name__ == '__main__':
    ...
    test_state = ImportGraphState({
        ...
        "chunks": [  # 模拟带item_name的文本切片（上游商品名称识别节点产出）
            {
                "content": "这是第一个测试文档的内容，用于验证向量化是否成功。",
                "title": "测试文档标题",
                "item_name": "测试项目",
                "file_title": "测试文件.pdf"
            },
            ...
            {
                "content": "这是第三个测试文档的内容，用于验证批量处理逻辑。",
                "title": "测试文档标题3",
                "item_name": "测试项目",
                "file_title": "测试文件.pdf"
            },
            {
                "content": "这是第四个测试文档的内容，用于验证批量处理逻辑。",
                "title": "测试文档标题4",
                "item_name": "测试项目",
                "file_title": "测试文件.pdf"
            },
            {
                "content": "这是第五个测试文档的内容，用于验证批量处理逻辑。",
                "title": "测试文档标题5",
                "item_name": "测试项目",
                "file_title": "测试文件.pdf"
            },
            {
                "content": "这是第六个测试文档的内容，用于验证批量处理逻辑。",
                "title": "测试文档标题6",
                "item_name": "测试项目",
                "file_title": "测试文件.pdf"
            },
            {
                "content": "这是第七个测试文档的内容，用于验证批量处理逻辑。",
                "title": "测试文档标题7",
                "item_name": "测试项目",
                "file_title": "测试文件.pdf"
            },
            {
                "content": "这是第八个测试文档的内容，用于验证批量处理逻辑。",
                "title": "测试文档标题8",
                "item_name": "测试项目",
                "file_title": "测试文件.pdf"
            }
